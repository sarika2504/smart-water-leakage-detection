...
1. Arduino reads flow values from both sensors.
2. The inlet and outlet flow rates are compared.
3. If the difference exceeds a predefined threshold, the system detects a water leak.
